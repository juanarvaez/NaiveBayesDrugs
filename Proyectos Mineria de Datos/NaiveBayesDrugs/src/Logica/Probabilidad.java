...
public class Probabilidad {
    ...
    public String[][] tabla2(String[][] datosProcesados, Double precisionEdad) {
        ...
        d1 = (double)Math.round((Math.sqrt(s1 - Math.pow(m1, 2)) * 10000d) / 10000d);
        d2 = (double)Math.round((Math.sqrt(s2 - Math.pow(m2, 2)) * 10000d) / 10000d);
        d3 = (double)Math.round((Math.sqrt(s3 - Math.pow(m3, 2)) * 10000d) / 10000d);
        d4 = (double)Math.round((Math.sqrt(s4 - Math.pow(m4, 2)) * 10000d) / 10000d);
        d5 = (double)Math.round((Math.sqrt(s5 - Math.pow(m5, 2)) * 10000d) / 10000d);
